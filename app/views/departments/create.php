<div class="p-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-[#111111] mb-2">إضافة قسم جديد</h1>
                <p class="text-[#666666]">أضف قسم جديد للشركة</p>
            </div>
                    ...
                    <div>
                        ...
                        <select id="manager_id" name="manager_id" dir="rtl"
                            ...
                            <?php foreach ($availableManagers as $manager): ?>
                                <option value="<?= $manager['id'] ?>"><?= htmlspecialchars($manager['name'], ENT_QUOTES, 'UTF-8') ?></option>
                            <?php endforeach; ?>
                        </select>
